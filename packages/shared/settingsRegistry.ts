...
> = [
  ...
  {
    key: "download.subtitleCat",
    label: "在线抓取中文字幕",
    anchor: "download",
    description: "源文件名不含 -C 时，从 SubtitleCat 检索并下载中文字幕；原生带 -C 的影片会跳过。",
  },
  {
    key: "download.subtitleCatFallbackTraditional",
    label: "回退繁体字幕",
    anchor: "download",
    description: "找不到简体 (zh-CN) 字幕时，接受繁体 (zh-TW) 字幕。",
  },
  {
    key: "download.embySubtitleNaming",
    label: "EMBY 字幕命名",
    anchor: "download",
    description: "将本地外挂中文字幕重命名为 [影片名].zh-CN.src.srt，下载字幕保存为 .zh-CN.subcat.srt。",
  },
  {
